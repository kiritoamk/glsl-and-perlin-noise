...
const startApp = () => {
  ...
  // lighting
  const dirLight = new THREE.DirectionalLight('#2596be', 0.3)
  dirLight.position.set(2, 2, 2)

  const ambientLight = new THREE.AmbientLight('#2596be', 0.2)
  ...
  cameraFolder.add(camera, 'fov', 1, 120).onChange(() => {
      camera.updateProjectionMatrix(); // Update projection matrix whenever FOV changes
  });
  cameraFolder.open();
